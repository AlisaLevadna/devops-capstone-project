...
def list_accounts():
    ...
    accounts_list = [a.serialize() for a in accounts]
    app.logger.info(f"Returned {len(accounts_list)} accounts")
...
def read_account(id):
    ...
    This endpoint will read a single Account based on the id passed in the path
    """
...
def delete_account(id):
    """
    Delete an Account
    This endpoint will update an Account based on the id in path
    """
